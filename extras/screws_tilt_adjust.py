...
#
# K2 adaptation notes (2026-04-06):
#   Creality's ProbePointsHelper uses the older 2-arg finalize callback
#   signature (offsets, positions) and passes positions as plain [x,y,z]
#   lists rather than objects with a .bed_z attribute. Two adjustments:
#     1. probe_finalize signature accepts (offsets, positions)
#     2. position Z accessed as pos[2] instead of pos.bed_z
#   No other changes from upstream Klipper master.
import math
from . import probe
